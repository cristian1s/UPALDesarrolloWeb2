const DropdownChat = () => {
    return (
      <div className="">
        ...
        {<div
          id="dropdownChat"
          className="margin-rigth20 z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-40 dark:bg-gray-700 dark:divide-gray-600"
