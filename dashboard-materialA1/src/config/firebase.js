...
import { getFirestore, doc, collection, getDocs, addDoc, onSnapshot,getDoc } from "firebase/firestore";
...
export { db, auth, doc, collection, getDoc, getDocs, addDoc, onSnapshot };
